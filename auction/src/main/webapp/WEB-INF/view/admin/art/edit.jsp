			...
			<tbody>
				<tr>
					...
					<td><input name="art_nm" type="text" placeholder="작품명을 입력하세요"
						 maxlength="300" value='${art.art_nm}' required></td>
				</tr>
				<tr>
					<th>작품요약정보</th>
					<td><input name="art_info" type="text"
						placeholder="요약 정보를 입력하세요"  maxlength="4000" value='${art.art_info}'></td>
				</tr>
				<tr>
					<th>작품설명</th>
				...
				<tr>
					...
					<td><input name="art_size" type="text"
						placeholder="사이즈를 입력하세요"  maxlength="150" value='${art.art_size}' required></td>
				</tr>
				<tr>
					<th>제작연도</th>
					<td>
				...
				<tr>
					<th>낙찰가</th>
					<td>
						<input name="art_bp" type="text"  maxlength="150" placeholder="낙찰가를 입력하세요" value="<fmt:formatNumber value='${art.art_bp}' pattern='#,###' />">
					</td>
				</tr>
				<tr>
					<th>작가명</th>
				...
				<tr>
					...
					<td><input name="art_sign" type="text" placeholder="서명 정보를 입력하세요"
						 maxlength="150" value='${art.art_sign}'></td>
				</tr>
			<tr>
				<th>추정가</th>
				<td>
					<input name="art_ep" type="text"  maxlength="150" placeholder="추정가를 입력하세요" value="<fmt:formatNumber value='${art.art_ep}' pattern='#,###' />">
				</td>
			</tr>
			<tr>
				<th>감정내용</th>
				<td>
					<input name="art_eval" type="text"  maxlength="150" placeholder="감정내용을 입력하세요" value="${art.art_eval}">
				</td>
			</tr>
				<tr>
					<th>등록상태</th>
